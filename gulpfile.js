...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new alphaadv name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/alphaadv.png')) {
        fs.renameSync(__dirname + '/admin/alphaadv.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/alphaadv.html')) {
        fs.renameSync(__dirname + '/widgets/alphaadv.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/alphaadv/js/alphaadv.js')) {
        fs.renameSync(__dirname + '/widgets/alphaadv/js/alphaadv.js', __dirname + '/widgets/alphaadv/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/alphaadv')) {
        fs.renameSync(__dirname + '/widgets/alphaadv',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /alphaadv/g,
        ...
        {
            match: /alphaadv/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'alphaadv'
        },
        {
